...
class IndexBuilder:
    ...
    def add_chunks(self, new_chunks: List[Chunk]) -> None:
        ...
        # Сохраняем снимок ВСЕХ чанков (старых + новых), чтобы следующий
        # инкрементальный вызов видел полный список.
        self.save_chunks_snapshot(all_chunks)
